/*
  ...
  1. New Data
    - Creates a sample marketing quiz with questions and options
    - Sets the quiz as published
    - Uses a fixed UUID for consistent referencing

  2. Security
    - Quiz is publicly accessible through RLS policies
*/
