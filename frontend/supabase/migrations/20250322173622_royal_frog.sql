/*
  # Fix Quiz Analytics Query

  1. Changes
    - Restructure analytics query to avoid nested aggregates
    - Use subqueries instead of CTEs for better performance
...
CREATE OR REPLACE FUNCTION get_quiz_analytics(p_quiz_id uuid)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
