...
export default function InstaFormsHome() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-text mb-4">Why Choose InstaForms?</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-text mb-4">What Our Users Say</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <div className="bg-accent rounded-2xl p-8 sm:p-12 text-center">
        <h2 className="text-2xl sm:text-3xl font-bold text-text mb-4">Ready to Create Professional Forms?</h2>
