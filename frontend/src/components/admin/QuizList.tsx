  ...
  if (error) {
    return (
      <div className="max-w-3xl mx-auto text-center py-12">
        ...
        <h3 className="text-lg font-medium text-text mb-2">Failed to load quizzes</h3>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-text">My Quizzes</h1>
          <p className="text-gray-600 mt-1">Manage your quiz collection</p>
        </div>
        <Link
      ...
      {quizzes.length === 0 ? (
        <div className="text-center py-16 bg-background rounded-lg shadow-md">
          ...
          <h3 className="text-xl font-semibold text-text mb-3">No quizzes yet</h3>
          <p className="text-gray-600 mb-8 max-w-md mx-auto">
            Create your first quiz to start engaging with your audience. It's easy to get started!
          </p>
          <div className="space-y-4 max-w-xs mx-auto">
            <Link
              to="/admin/quizzes/new"
              className="w-full flex items-center justify-center px-6 py-3 bg-secondary text-white rounded-lg hover:bg-primary transition-colors"
            >
              <PlusCircle className="w-5 h-5 mr-2" />
              Create Quiz
            </Link>
            <Link
              to="/quiz/sample"
              className="w-full flex items-center justify-center px-6 py-3 border-2 border-secondary text-secondary rounded-lg hover:bg-accent transition-colors"
            >
