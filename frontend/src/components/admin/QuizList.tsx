  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-bold text-text">My GoForms</h1>
      ...
      {quizzes.length === 0 ? (
        <div className="text-center py-16 bg-background rounded-lg shadow-md">
          ...
          <h3 className="text-xl font-semibold text-text mb-3">No GoForms yet</h3>
              ...
              {quizzes.map((quiz) => (
                <tr key={quiz.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-right space-x-2">
                    <Link
                      to={`/quiz/${quiz.id}`}
                      className="inline-flex items-center p-1 text-secondary hover:text-primary transition-colors"
