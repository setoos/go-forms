...
export default function ReportTemplatesPage() {
  ...
  const quillRefs = React.useRef<{[key: string]: ReactQuill | null}>({});
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Create and manage report templates for quiz results
            </p>
          </div>
        </div>
                ...
                <div key={section.id} className="mb-6 last:mb-0">
                  ...
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ 
                      __html: processTemplateVariables(section.content, previewVariables)
                    }}
                  />
                </div>
              ))}
