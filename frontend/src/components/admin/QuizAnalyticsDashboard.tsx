...
import type { QuizAnalytics } from '../../types/quiz.ts';
...
export default function QuizAnalyticsDashboard({ analytics, onExport }: Props) {
  ...
  const scoreDistribution = analytics.recentAttempts.reduce((acc: Record<number, number>, attempt: { score?: number }) => {
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-background divide-y divide-gray-200">
              {analytics.recentAttempts.map((attempt: { id: string; participant_name: string; participant_email: string; score?: number; completed_at?: string; started_at?: string }) => (
                <tr key={attempt.id}>
