...
export default function DashboardLayout() {
  ...
  const isResultsPage = location.pathname === '/results' || location.pathname === '/results/success';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1 relative">
        ...
        {/* Sidebar */}
        {showSidebar && !isHomePage && !isAuthPage && !isQuizPage && !isResultsPage && (
          <div 
        ...
        {/* Main content */}
        <main className={`flex-1 ${showSidebar && !isHomePage && !isAuthPage && !isQuizPage && !isResultsPage ? '' : ''}`}>
