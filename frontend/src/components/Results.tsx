...
import { Brain, Download, ArrowRight, Send, FileSpreadsheet, Mail, Clock, ArrowLeft } from 'lucide-react';
...
function Results() {
  ...
  const handleSendEmail = useCallback(async (response?: ResponseType) => {
    if (sendingEmail) return;
    setSendingEmail(true);

    try {
      const success = await sendResultsEmail(response || {
